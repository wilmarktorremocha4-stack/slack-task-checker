...
export async function GET(request: Request) {
  ...
  if (error) {
    console.error("[weekly-digest] DB error:", error);
    return NextResponse.json({ error: "Database error" }, { status: 500 });
  }

  // Tasks completed this week (may have been created before the window)
  ...
  const blocks: any[] = [
    ...
    },
    {
      ...
      text: {
        type: "mrkdwn",
        text: "Here's a summary of all tasks assigned to your team this week.",
      },
    },
    { type: "divider" },
    {
